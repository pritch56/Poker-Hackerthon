"""LAG-03: loose-aggressive, frequent 3-bets and barrels."""
import random, eval7

BOT_NAME = "LAG-03"
_RNG = random.Random(5003)
_OPEN = {'AA', 'KK', 'QQ', 'JJ', 'AKs', 'TT', '99', 'AKo', 'AQs', 'AJs', 'KQs', 'AQo', '88', '77', 'ATs', 'KJs', 'QJs', 'AJo', 'KQo', 'JTs', 'T9s', 'KTs', '66', '55', '44', '33', '22', 'ATo', 'KJo', 'QTs', '98s', '87s', 'A9s'}
_3BP = 0.15
_BARREL = 0.5
