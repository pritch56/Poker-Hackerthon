"""Positional-04: only plays late position."""
import eval7

BOT_NAME = "Positional-04"
_LATE_OPEN = {'AA', 'KK', 'QQ', 'JJ', 'AKs', 'TT', '99', 'AKo', 'AQs', 'AJs', 'KQs', 'AQo', '88', '77', 'ATs', 'KJs', 'QJs', 'AJo', 'KQo', 'JTs', 'T9s', 'KTs', '66', '55', '44', '33', '22', 'ATo', 'KJo', 'QTs', '98s', '87s', 'A9s', 'A8s', 'A7s', 'A5s', 'A4s', 'A3s', 'A2s', 'K9s', 'Q9s', 'J9s', 'T8s', '97s', '86s', '76s', '65s', '54s', 'KTo', 'QJo', 'JTo', 'T9o', 'A6s', 'K8s', 'K7s', 'Q8s', 'J8s', 'T7s', '96s', '85s', '75s', '64s', 'A9o', 'A8o', 'A7o', 'A6o', 'K9o', 'Q9o', 'J9o', 'T9o', '98o'}
_THRESH_SEATS = 2
