"""Positional-03: only plays late position."""
import eval7

BOT_NAME = "Positional-03"
_LATE_OPEN = {'AA', 'KK', 'QQ', 'JJ', 'AKs', 'TT', '99', 'AKo', 'AQs', 'AJs', 'KQs', 'AQo', '88', '77', 'ATs', 'KJs', 'QJs', 'AJo', 'KQo', 'JTs', 'T9s', 'KTs', '66'}
_THRESH_SEATS = 1
