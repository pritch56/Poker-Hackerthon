"""LAG-01: loose-aggressive, frequent 3-bets and barrels."""
import random, eval7

BOT_NAME = "LAG-01"
_RNG = random.Random(5001)
_OPEN = {'AA', 'KK', 'QQ', 'JJ', 'AKs', 'TT', '99', 'AKo', 'AQs', 'AJs', 'KQs', 'AQo', '88', '77', 'ATs', 'KJs', 'QJs', 'AJo', 'KQo', 'JTs', 'T9s', 'KTs', '66', '55', '44', '33', '22', 'ATo', 'KJo', 'QTs', '98s', '87s', 'A9s', 'A8s', 'A7s', 'A5s', 'A4s', 'A3s', 'A2s', 'K9s', 'Q9s', 'J9s', 'T8s', '97s', '86s', '76s', '65s', '54s', 'KTo', 'QJo', 'JTo', 'T9o'}
_3BP = 0.2
_BARREL = 0.55
